...
const EventPhotos = ({ lastYearEventPhotos }) => {
  return (
    <div className="flex flex-col gap-8 text-center items-center justify-center my-10">
      ...
      {/*Video Section*/}
      <iframe src={`https://www.youtube.com/embed/${lastYearEventPhotos.videoId}?autoplay=1&mute=1&loop=1&playlist=${lastYearEventPhotos.videoId}`} frameBorder="0" allow="autoplay"  width="1500" height="844"/>
